        ...
        Column {
          ...
          Row {
            ...
            Column {
              ...
              Row {
                ...
                Text { anchors.verticalCenter: parent.verticalCenter; text: "SABARCHY"; color: root.contentForeground; font.family: root.contentFontFamily; font.pixelSize: Style.font.title; font.bold: true; font.letterSpacing: 1.4 }
            ...
            Row {
              ...
              Rectangle {
                ...
                border.width: Style.spacing.hairline; border.color: Qt.rgba(root.contentForeground.r, root.contentForeground.g, root.contentForeground.b, 0.18)
                Text { id: openLabel; anchors.centerIn: parent; text: root.compact ? "󰏌" : "OPEN SAB  󰏌"; color: root.contentForeground; font.family: root.contentFontFamily; font.pixelSize: Style.font.caption; font.bold: true }
          ...
          Rectangle {
            ...
            Row {
              ...
              Rectangle {
                ...
                Text { anchors.centerIn: parent; text: root.compact ? "󰑐" : "󰑐  RETRY"; color: Color.accent; font.family: root.contentFontFamily; font.pixelSize: Style.font.caption; font.bold: true }
          ...
          Rectangle {
            ...
            Row {
              ...
              Text { anchors.verticalCenter: parent.verticalCenter; text: "󰋊"; color: Color.urgent; font.family: root.contentFontFamily; font.pixelSize: Style.font.body }
              Text { anchors.verticalCenter: parent.verticalCenter; text: "LOW DISK SPACE  ·  " + String(root.pipelineData && root.pipelineData.disk ? root.pipelineData.disk.free || "Unknown" : "Unknown") + " FREE"; color: Color.urgent; font.family: root.contentFontFamily; font.pixelSize: Style.font.bodySmall; font.bold: true }
            }
          }
          ...
          Row {
            ...
            Text { text: "NOW"; color: root.contentForeground; font.family: root.contentFontFamily; font.pixelSize: Style.font.body; font.bold: true; font.letterSpacing: 1.2 }
            Text { text: root.queueTotal === 1 ? "1 ACTIVE JOB" : String(root.queueTotal) + " ACTIVE JOBS"; color: Color.accent; font.family: root.contentFontFamily; font.pixelSize: Style.font.caption; font.bold: true }
            Text { visible: root.activeJobs.length > 0; text: String(root.pipelineData && root.pipelineData.queue ? root.pipelineData.queue.timeleft || "0:00:00" : "0:00:00") + " LEFT"; color: Qt.darker(root.contentForeground, 1.5); font.family: root.contentFontFamily; font.pixelSize: Style.font.caption }
          }
          ...
          Column {
            ...
            Rectangle {
              ...
              Row {
                ...
                Text { text: "󰑪"; color: Qt.darker(root.contentForeground, 1.55); font.family: root.contentFontFamily; font.pixelSize: Style.font.display }
                Column {
                  anchors.verticalCenter: parent.verticalCenter; spacing: Style.space(4)
                  Text { text: root.connected ? "QUEUE IS CLEAR" : "WAITING FOR SABNZBD"; color: root.contentForeground; font.family: root.contentFontFamily; font.pixelSize: Style.font.body; font.bold: true }
                  Text { text: root.connected ? "New downloads will appear here with live progress and processing state." : "Start SABnzbd to reconnect this dashboard."; color: Qt.darker(root.contentForeground, 1.5); font.family: root.contentFontFamily; font.pixelSize: Style.font.bodySmall }
                }
              }
            }
              ...
              delegate: Rectangle {
                ...
                Column {
                  ...
                  Row {
                    ...
                    Text { anchors.verticalCenter: parent.verticalCenter; text: root.statusIcon(activeCard.modelData.status); color: activeCard.stateColor; font.family: root.contentFontFamily; font.pixelSize: Style.font.title }
                    Text {
                      id: activeTitle
                    ...
                    Rectangle {
                      ...
                      Text { id: statusLabel; anchors.centerIn: parent; text: String(activeCard.modelData.status || "WORKING").toUpperCase(); color: activeCard.stateColor; font.family: root.contentFontFamily; font.pixelSize: Style.font.caption; font.bold: true; font.letterSpacing: 0.7 }
                    }
                  ...
                  Row {
                    ...
                    Text { id: progressLabel; anchors.verticalCenter: parent.verticalCenter; text: Math.round(Number(activeCard.modelData.progress || 0)) + "%"; color: root.contentForeground; font.family: root.contentFontFamily; font.pixelSize: Style.font.body; font.bold: true }
                  }
                  Row {
                    width: parent.width; spacing: Style.space(18)
                    visible: !root.compact
                    Text { text: String(activeCard.modelData.category || "UNCATEGORIZED").toUpperCase(); color: Qt.darker(root.contentForeground, 1.48); font.family: root.contentFontFamily; font.pixelSize: Style.font.caption; font.bold: true }
                    Text { text: String(activeCard.modelData.size || ""); color: Qt.darker(root.contentForeground, 1.55); font.family: root.contentFontFamily; font.pixelSize: Style.font.caption }
                    ...
                    Text { id: remainingText; text: activeCard.modelData.timeleft ? String(activeCard.modelData.timeleft) + " LEFT  ·  " + String(activeCard.modelData.sizeleft || "") : String(activeCard.modelData.sizeleft || ""); color: Qt.darker(root.contentForeground, 1.4); font.family: root.contentFontFamily; font.pixelSize: Style.font.caption }
                  }
                  Rectangle {
            ...
            Rectangle {
              ...
              Text { anchors.centerIn: parent; text: "SHOW MORE  ·  " + root.activeJobs.length + " OF " + root.queueTotal; color: Color.accent; font.family: root.contentFontFamily; font.pixelSize: Style.font.caption; font.bold: true }
          ...
          Rectangle {
            ...
            Row {
              ...
              Rectangle {
                ...
                Text { anchors.centerIn: parent; text: "CANCEL"; color: Qt.darker(root.contentForeground, 1.35); font.family: root.contentFontFamily; font.pixelSize: Style.font.caption; font.bold: true }
          ...
          Rectangle {
            ...
            ListView {
              ...
              Text { visible: recentList.count === 0; anchors.centerIn: parent; text: root.historyFilter === "issues" ? "No failures in loaded history" : "No matching history"; color: Qt.darker(root.contentForeground, 1.55); font.family: root.contentFontFamily; font.pixelSize: Style.font.bodySmall; font.italic: true }
              delegate: Rectangle {
                id: recentCard
                required property var modelData
                required property int index
                ...
                Row {
                  ...
                  Text { anchors.verticalCenter: parent.verticalCenter; text: root.statusIcon(recentCard.modelData.status); color: recentCard.modelData.failed ? Color.urgent : Color.accent; font.family: root.contentFontFamily; font.pixelSize: Style.font.body }
                  Column {
                    ...
                    Text { visible: recentCard.modelData.failed; width: parent.width; text: String(recentCard.modelData.failure || "SABnzbd reported an unspecified failure"); elide: Text.ElideRight; color: Qt.darker(root.contentForeground, 1.4); font.family: root.contentFontFamily; font.pixelSize: Style.font.caption }
                    Text { visible: recentCard.expanded; width: parent.width; text: String(recentCard.modelData.category || "Uncategorized").toUpperCase() + "  ·  " + String(recentCard.modelData.size || "Unknown size") + (recentCard.modelData.completed ? "  ·  " + String(recentCard.modelData.completed) : ""); elide: Text.ElideRight; color: Qt.darker(root.contentForeground, 1.45); font.family: root.contentFontFamily; font.pixelSize: Style.font.caption; font.bold: true }
                  }
                  Rectangle {
                    id: retryButton
            ...
            Rectangle {
              ...
              Text { anchors.centerIn: parent; text: "LOAD MORE HISTORY  ·  " + root.recentJobs.length + " OF " + root.historyTotal; color: Color.accent; font.family: root.contentFontFamily; font.pixelSize: Style.font.caption; font.bold: true }
